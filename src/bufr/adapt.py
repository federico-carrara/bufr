...
import yaml
import time
from bufr.nets import MNISTCNNBase, ResNet18, learner_distances, \
...
from bufr.lib.data_utils import get_static_emnist_dataloaders, get_static_emnist_idx_dataloaders, \
        ...
        if epoch % alg_config["val_freq"] == 0:
            ...
            if wandb_logger is not None:
                wandb_logger.log({"val/loss": valid_loss / n_val_samples,
                                  "val/acc": valid_acc / n_val_samples}, step=epoch)
